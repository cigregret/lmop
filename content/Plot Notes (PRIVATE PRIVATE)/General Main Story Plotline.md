...
- phandalin to thundertree
	- equipment upgrades
	- thundertree, then agatha, then orcs (new allies)
- cragmaw castle
	- save gundren
	- learn of gundrens idealistic (yet capitalist) plans for phandalin and the forge of spells
...
- real boss is the keeper of the forge, an automaton that is basically weathermon
		...
		- phase 3: can only win by countering the one attack, doesnt actually have hp anymore. the counter is to put the immovable rod inside its chest to prevent it from moving, at which point it shuts down.
- yayyyy LMOP done!! time for the +
	- build homebase w gundren (if desired)
	- roll low rank credits
	- level 4
- one more arena of wild magic 
	- time skips forward by 40 years
...
- his lair can be found in the moonshae isles
	- thick mist surrounding the isles keeps anyone from getting in or out. 
- planeshifting is the only way of getting in/out. leaves ONE path
	- eventually have to brute force it through the mist and hope for the best
		- cant call raven queen since madame doesnt know how
		- cant call cerise since time moves vastly different in the feywilde
		- cant call bahamut since paladins != clerics
		- any other planes aren't accessible, and party is too low level to not just brute force it
- using underground network and old allies, learn that the easiest port would be in waterdeep
	- luskar insists on coming with, it is a 1 week travel from phandalin
	- bigger push when shayla finds out that open lord of waterdeep is dead
- arrive in waterdeep, stock up on supplies
	- bad memories for shayla, small run in with lords alliance who recognize her image from legend
	- learn more of the [[Open Lord Garakh Silverhand]]'s supposed death by unknown cause
		- hints towards bahamut's justice in scraping the world anew
		- finds out that open lord is still alive?????
	- sildar "bumps" into the party (learns of their existence from previous lords alliance encounter)and orders their immediate execution by the state
		- to the UNDERGROUND BABYYYY
		- find out that one of the items needed to appease bahamut is in the open lord's estate - now a HEIST MISSION babyyyy
- **Level 8 somewhere around here**
- after heist, steal a boat and go SWASHBUCKLING YOO HOO AND A BOTTLE OF RUM
	- give LOTS of time to roleplay during this journey and everyone to talk about what they kept secret earlier
	- have friendly duels with prop weapons, gambling, etc. PERFECT time for solo sessions with people's backstories
- eventually, they reach the mist. the oceans get choppy, and the established conditions for the ghost ships to appear are set
	- guess what? it does. cool. 
	- FIGHT ON THE SHIPS
- eventually, large tentacles drag both ships down underneath the sea, and everyone's vision goes black as they lose consciousness hundreds of yards underwater, with no land in sight. domain of dread for ctharnidd
	- they wake up in pairs to make combat scarier. [[Jukha]] is with the odd one out. yet they can breathe and move as if they were on land
	- one group meets a fish-person who can swim around, and begins to explain where they are
- RUN SHANGRI-LA FRONTIER CTHARNIDD REMAKE YIPPEEEEE
	- add one side quest for the central castle where fry finds the cloister and uses shayla's item that will let him get a key to mount celestia
	- make ctharnidd jealous of the raven queen for picking up madame wonder before him, hence the forced entry into its domain of dread
	- the tower keepers are the same, castle is largely the same, but one phase of the ctharnidd fight is everyone fighting their shadowborne
- **should be around level 12 at the end of ctharnidd**
- once they resurface, they are on the shore of what seems to be one of the moonview isles. they are all together, yet need to find civilization quick to see how much time is left before bahamut's conquest
	- give them like a week
- must find the heretics of bahamut who are 'guarding' the entrance to mount celestia
